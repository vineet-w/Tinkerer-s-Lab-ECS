...
export default function Home() {
 ...
 const galleryImages = Array(12).fill(0).map((_, i) => `/images/gallery/gallery${i % 4 + 1}.jpg`);
    ...
    <div className="min-h-screen flex flex-col bg-[#0D0D0D] text-gray-300 font-sans overflow-hidden relative">
      ...
      <main className="flex-1 px-8 sm:px-20 py-12 flex flex-col relative z-10">
        ...
        <motion.section className="min-h-[80vh] flex flex-col justify-center items-center text-center mb-24" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          ...
          <motion.button className="px-8 py-3 bg-gradient-to-r from-[#9F70FD] to-[#7a4be6] text-white rounded-full font-bold shadow-lg transition-all" whileHover={{ scale: 1.05, boxShadow: "0 0 30px #9F70FD" }} whileTap={{ scale: 0.95 }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    <motion.button
                      className="w-full px-6 py-3 bg-gradient-to-r from-[#9F70FD] to-[#00F5D4] text-white rounded-lg font-bold font-mono"
